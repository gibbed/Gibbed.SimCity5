...
namespace Gibbed.SimCity5.FileFormats.Variants.Values
{
    public class Int8ValueVariant : ValueVariant<sbyte>
    {
        ...
        public Int8ValueVariant(sbyte value)
            : base(value)
        {
        }
        ...
        public static explicit operator Int8ValueVariant(sbyte value)
        {
            return new Int8ValueVariant(value);
        }

        public static explicit operator sbyte(Int8ValueVariant variant)
        {
