...
namespace Gibbed.SimCity5.FileFormats.Variants.Values
{
    public sealed class TextValueVariant : ValueVariant<LocalizedText>
    {
        ...
        public TextValueVariant(LocalizedText value)
            : base(value)
        {
        }
        ...
        public static explicit operator TextValueVariant(LocalizedText value)
        {
            return new TextValueVariant(value);
        }

        public static explicit operator LocalizedText(TextValueVariant variant)
        {
        ...
        {
            this.Value = LocalizedText.Read(input, endian);
        }
    }
}
