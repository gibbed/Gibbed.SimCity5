...
namespace Gibbed.SimCity5.FileFormats.Variants.Values
{
    public sealed class Int16ValueVariant : ValueVariant<short>
    {
        ...
        public Int16ValueVariant(short value)
            : base(value)
        {
        }
        ...
        public static explicit operator Int16ValueVariant(short value)
        {
            return new Int16ValueVariant(value);
        }

        public static explicit operator short(Int16ValueVariant variant)
        {
        ...
        {
            output.WriteValueS16(this.Value, endian);
        }

        internal override void Deserialize(Stream input, Endian endian)
        {
            this.Value = input.ReadValueS16(endian);
        }
    }
}
