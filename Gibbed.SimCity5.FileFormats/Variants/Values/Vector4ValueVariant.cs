...
namespace Gibbed.SimCity5.FileFormats.Variants.Values
{
    public class Vector4ValueVariant : ValueVariant<Vector4>
    {
        ...
        public Vector4ValueVariant(Vector4 value)
            : base(value)
        {
        }
        ...
        public static explicit operator Vector4ValueVariant(Vector4 value)
        {
            return new Vector4ValueVariant(value);
        }

        public static explicit operator Vector4(Vector4ValueVariant variant)
        {
        ...
        {
            this.Value = Vector4.Read(input, endian);
        }
    }
}
