...
{
    internal class ResourceKeyArrayHandler : SimpleArrayHandler<ResourceKeyArrayVariant, ResourceKey>
    {
        ...
        protected override void ExportItem(ResourceKey value, XmlWriter writer)
        {
        ...
        protected override void ImportItem(XPathNavigator nav, out ResourceKey value)
        {
