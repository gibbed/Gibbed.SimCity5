...
{
    internal class Vector4ValueHandler : SimpleValueHandler<Vector4ValueVariant, Vector4>
    {
        ...
        protected override void ExportValue(Vector4 value, XmlWriter writer)
        {
        ...
        protected override void ImportValue(XPathNavigator nav, out Vector4 value)
        {
