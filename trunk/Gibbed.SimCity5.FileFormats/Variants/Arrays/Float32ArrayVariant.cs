...
namespace Gibbed.SimCity5.FileFormats.Variants.Arrays
{
    public sealed class Float32ArrayVariant : ArrayVariant<float>
    {
        ...
        public Float32ArrayVariant(IEnumerable<float> value)
            : base(value)
        {
        ...
        public static explicit operator Float32ArrayVariant(List<float> value)
        {
            return new Float32ArrayVariant(value);
        }

        public static explicit operator List<float>(Float32ArrayVariant variant)
        {
            return variant.Value.ToList();
        }

        protected override void SerializeItem(float value, Stream output, Endian endian)
        {
            output.WriteValueF32(value, endian);
        }

        protected override void DeserializeItem(out float value, Stream input, Endian endian)
        {
