...
namespace Gibbed.SimCity5.FileFormats.Variants.Values
{
    public class BoundingBoxValueVariant : ValueVariant<BoundingBox>
    {
        ...
        public BoundingBoxValueVariant(BoundingBox value)
            : base(value)
        {
        }
        ...
        public static explicit operator BoundingBoxValueVariant(BoundingBox value)
        {
            return new BoundingBoxValueVariant(value);
        }

        public static explicit operator BoundingBox(BoundingBoxValueVariant variant)
        {
        ...
        {
            this.Value = BoundingBox.Read(input, endian);
        }
    }
}
