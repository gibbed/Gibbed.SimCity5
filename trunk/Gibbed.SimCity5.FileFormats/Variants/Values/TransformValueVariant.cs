...
namespace Gibbed.SimCity5.FileFormats.Variants.Values
{
    public class TransformValueVariant : ValueVariant<Transform>
    {
        ...
        public TransformValueVariant(Transform value)
            : base(value)
        {
        }
        ...
        public static explicit operator TransformValueVariant(Transform value)
        {
            return new TransformValueVariant(value);
        }

        public static explicit operator Transform(TransformValueVariant variant)
        {
        ...
        {
            this.Value = Transform.Read(input, endian);
        }
    }
}
