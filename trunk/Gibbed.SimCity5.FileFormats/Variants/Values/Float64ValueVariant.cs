...
namespace Gibbed.SimCity5.FileFormats.Variants.Values
{
    public sealed class Float64ValueVariant : ValueVariant<double>
    {
        ...
        public Float64ValueVariant(double value)
            : base(value)
        {
        }
        ...
        {
            get { return VariantType.Float64; }
        }
        ...
        public static explicit operator Float64ValueVariant(double value)
        {
            return new Float64ValueVariant(value);
        }

        public static explicit operator double(Float64ValueVariant variant)
        {
        ...
        {
            output.WriteValueF64(this.Value, endian);
        }

        internal override void Deserialize(Stream input, Endian endian)
        {
            this.Value = input.ReadValueF64(endian);
        }
    }
}
