...
{
    internal class ColorRgbaValueHandler : SimpleValueHandler<ColorRgbaValueVariant, ColorRgba>
    {
        ...
        protected override void ExportValue(ColorRgba value, XmlWriter writer)
        {
        ...
        protected override void ImportValue(XPathNavigator nav, out ColorRgba value)
        {
