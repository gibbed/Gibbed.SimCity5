...
{
    internal class ColorRgbArrayHandler : SimpleArrayHandler<ColorRgbArrayVariant, ColorRgb>
    {
        public override string Name
        {
            get { return "colorRGBs"; }
        }
        ...
        protected override void ExportItem(ColorRgb value, XmlWriter writer)
        {
        ...
        protected override void ImportItem(XPathNavigator nav, out ColorRgb value)
        {
